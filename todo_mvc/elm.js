	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(_user$project$Main$styles)
					])),
				A2(
...
var _user$project$Main$Todo = F3(
	function (a, b, c) {
		return {title: a, completed: b, editing: c};
	});
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {todos: a, todo: b, filter: c};
	});
...
var _user$project$Main$initialModel = {
	todos: _elm_lang$core$Native_List.fromArray(
		[
			{title: 'The first todo', completed: false, editing: false}
		]),
